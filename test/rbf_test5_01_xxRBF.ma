...
//Name: rbf_test5_xxRBF.ma
//Last modified: Wed, Mar 17, 2010 11:57:53 AM
//Codeset: 936
requires maya "2009";
requires "rbf_d" "1.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 23.3654897442829 34.464685877592991 6.1540324623957776 ;
	setAttr ".r" -type "double3" -58.538352729577355 50.199999999977997 -4.9687650164045098e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 40.918753139476266;
